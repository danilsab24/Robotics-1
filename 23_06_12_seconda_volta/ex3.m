...
values = [0, pi/2, -pi/2, pi];

% Inizializzazione di un contatore per generare nomi di variabili unici
counter = 1;

% Definizione dei valori possibili per q2 e q3
values = [0, pi/2, -pi/2, pi];

rank_J = rank(subs(J_L_A,[q2,q3],[pi/2,pi/2]))
