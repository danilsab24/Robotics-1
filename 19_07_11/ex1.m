...
syms alpha d d1 d2 d4 d6 a a1 a2 a3 a4 theta q1 q2 q3 L1 L2 L3
...
J_L_e = J_L_A(1:3, 1:3)+p_ep

J_L_e_t = J_L_e.'

tau_mid_frame_3 = J_L_e_t*F

tau_mid_frame_3_subs = subs(tau_mid_frame_3, [q1,q2,q3,L1,L2,L3],[pi/3,-pi/6,-pi/6,1,0.5,0.25])
