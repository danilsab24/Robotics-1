...
p_dot_dot = simplify(J*q_dot_dot + J_dot*q_dot, steps=1000)
...
J_inv = simplify(inv(J), steps=100)
q_dot_dot = simplify(-J_inv*J_dot*q_dot, steps=1000)

prova = simplify(J_dot*q_dot , steps=1000)

finale = simplify(J_inv * prova, steps = 100)