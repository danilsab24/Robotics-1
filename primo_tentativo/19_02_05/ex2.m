...
p_04_qs = subs(p_04, [q2,q3], [-pi/2, -pi/2]);

A_0_4_q0 = subs(A_0_4, [q1,q2,q3,q4], [0,0,0,0]);

p_TCP = [0; 0.1; 0.2;1];

p_44_TCP = eval(A_0_4_q0*p_TCP);

p_0_E = p_04;
p_1_E = p_04 - p_01;
p_2_E = p_04 - p_02;
p_3_E = simplify(p_04 - p_03, steps=100);
...
J_L_mid_frame_1 = J_L_A_mid_frame_1(1:3, :)
J_A_mid_frame_1 = J_L_A_mid_frame_1(4:end, :)

% poichè le matrici sono 3x4 considero le sottomatrici per capire come
% ridurre il rango

J_L_mid_frame_1_3x3 = J_L_mid_frame_1(:, 1:3)
det_J_L_mid_frame_1_3x3 = simplify(det(J_L_mid_frame_1_3x3), steps=1000)

try1 = subs(det_J_L_mid_frame_1_3x3, [q2,q3],[0,-pi/2])

J_L_mid_frame_1_3x3_2 = J_L_mid_frame_1(:, [1, 2, 4])
det_J_L_mid_frame_1_3x3_2 = simplify(det(J_L_mid_frame_1_3x3_2), steps=100)

J_L_mid_frame_1_3x3_3 = J_L_mid_frame_1(:, [1, 3, 4])
det_J_L_mid_frame_1_3x3_3 = simplify(det(J_L_mid_frame_1_3x3_3), steps=100)

det_J_A_mid_frame_1 = det(J_A_mid_frame_1*J_A_mid_frame_1.')

J_L_A_q0 = simplify(subs(J_L_A, [q1,q2,q3,q4], [0,0,0,0]), Steps=100)

rank_J_L_q0 = rank(J_L_A_q0(1:3, :))

v_b = [1;0;1]

J_L_q0 = J_L_A_q0(1:3, :)

J_L_q0_inv = inv(J_L_q0(:, 1:3))

J_L_q0_final = [J_L_q0_inv;0 0 0]

q_dot_b = J_L_q0_final*v_b