...
syms alpha d d1 d2 d4 d6 a a1 a2 a3 a4 theta q1 q2 q3 q4 q5 q6 L
...
J_L_A_q0 = subs(J_L_A, [q1,q2,q3,q4], [0,pi/2,L,0])

null_space_J_L_q0 = null(J_L_A_q0(1:3, :).'*J_L_A_q0(1:3, :))

range_space_J_LA = colspace(J_L_A_q0 * J_L_A_q0.')

rank_J_L_A = rank(range_space_J_LA)

rank_2 = rank([range_space_J_LA [1; 0; 1; 0; 0; -2]])
