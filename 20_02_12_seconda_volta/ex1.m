...
syms alpha d d1 d2 d4 d6 a a1 a2 a3 a4 theta q1 q2 q3 q4 q5 q6 lb la
...
P_1 = subs(p_04, [q1,q2,q3,q4,la,lb], [0,0,0,0,0.5,0.75])
P_2 = subs(p_04, [q1,q2,q3,q4,la,lb], [1,0,-pi/2,pi/2,0.5,0.75])
...
J_A_subs = subs(J_A,q3,0)
NULL_SPACE_J_A_subs = null(J_A_subs)
